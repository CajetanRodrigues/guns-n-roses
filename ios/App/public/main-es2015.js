...
const routes = [
    ...
    {
        path: 'playlist/:id',
        loadChildren: () => __webpack_require__.e(/*! import() | playlist-playlist-module */ "playlist-playlist-module").then(__webpack_require__.bind(null, /*! ./playlist/playlist.module */ "./src/app/playlist/playlist.module.ts")).then(m => m.PlaylistPageModule)
    },
    {
        path: 'login',
        loadChildren: () => __webpack_require__.e(/*! import() | login-login-module */ "login-login-module").then(__webpack_require__.bind(null, /*! ./login/login.module */ "./src/app/login/login.module.ts")).then(m => m.LoginPageModule)
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, http, appService, authService) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _providers_player_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./providers/player.service */ "./src/app/providers/player.service.ts");
...
/* harmony import */ var _providers_search_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./providers/search.service */ "./src/app/providers/search.service.ts");
...
/* harmony import */ var _providers_browse_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./providers/browse.service */ "./src/app/providers/browse.service.ts");
/* harmony import */ var _providers_albums_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./providers/albums.service */ "./src/app/providers/albums.service.ts");
/* harmony import */ var _app_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./app.service */ "./src/app/app.service.ts");
/* harmony import */ var _providers_artists_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./providers/artists.service */ "./src/app/providers/artists.service.ts");
/* harmony import */ var _providers_playlists_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./providers/playlists.service */ "./src/app/providers/playlists.service.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_10__["NgModule"])({
        ...
        providers: [
            ...
            _providers_playlists_service__WEBPACK_IMPORTED_MODULE_9__["PlaylistsService"],
            _providers_artists_service__WEBPACK_IMPORTED_MODULE_8__["ArtistsService"],
            _app_service__WEBPACK_IMPORTED_MODULE_7__["AppService"],
            _providers_albums_service__WEBPACK_IMPORTED_MODULE_6__["AlbumsService"],
            _providers_browse_service__WEBPACK_IMPORTED_MODULE_5__["BrowseService"],
            _ionic_native_keyboard_ngx__WEBPACK_IMPORTED_MODULE_4__["Keyboard"],
            _providers_search_service__WEBPACK_IMPORTED_MODULE_3__["SearchService"],
            _providers_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"],
            _providers_player_service__WEBPACK_IMPORTED_MODULE_1__["PlayerService"],
...
ArtistsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
BrowseService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], BrowseService);
...
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js");
/* harmony import */ var _app_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../app.service */ "./src/app/app.service.ts");
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./auth.service */ "./src/app/providers/auth.service.ts");
...
let PlayerService = class PlayerService {
    constructor(http, appService, authService) {
        this.http = http;
        this.appService = appService;
        this.authService = authService;
    }
    pauseUserPlayback(token) {
    ...
    startResumeUserPlayback(token, track) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./auth.service */ "./src/app/providers/auth.service.ts");
...
let PlaylistsService = class PlaylistsService {
    ...
    fetchPlaylistCover(token, playlistId) {
...
PlaylistsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
module.exports = __webpack_require__(/*! C:\Users\maver\Desktop\guns-n-roses\src\main.ts */"./src/main.ts");
